...
public class ItemArrayAdapter extends RecyclerView.Adapter<ItemArrayAdapter.ExampleViewHolder> {
    ...
    private ArrayList<Container_item> mExampleList;
    ...
    public ItemArrayAdapter(ArrayList<Container_item> exampleList) {
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        Container_item currentItem = mExampleList.get(position);
